...
class Slot implements ISlot {
	...
	/** Push the given values of value Array into the local _params Array **/
	...
	/** Execute the listener with the local _params **/
	...
	/** Execute the listener with both the given value as well as the local _params **/
	...
	/** Execute the listener with the given array of valueObjects **/
	...
	/** Check if the listener or signal is null **/
